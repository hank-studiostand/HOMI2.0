          ...
          <Section title="브라우저 알림" icon={Bell}>
            ...
            {browserPermission === 'denied' && (
              ...
              >
                ...
                <span>
                  브라우저가 알림을 차단했습니다. 브라우저 주소창 옆 자물쇠 아이콘 → 알림 → 허용으로 변경해주세요.
                </span>
              </div>
            )}
            ...
            >
              ...
              <div style={{ color: 'var(--text-muted)' }}>
                ...
                <ol className="space-y-0.5 list-decimal list-inside">
                  <li>Slack 워크스페이스 → 앱 관리 → 인커밍 웹훅 검색 및 추가</li>
                  <li>채널 선택 → 웹훅 URL 복사</li>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[11px]" style={{ color: 'var(--text-muted)' }}>생성 중 오류가 발생했습니다.</p>
                </div>
              </div>
            </div>
          </Section>
